...
class ModelTrainer:
    ...
    def train_with_zkp_sampling(self, train_loader, test_loader, zkp_generator, sample_rates=None):
        """
        ...
        Args:
            ...
            sample_rates: 抽样次数列表，默认为[10, 20, 30, 40, 50]
        ...
        for sample_rate in sample_rates:
            ...
            # 获取证明文件大小
            proof_size = os.path.getsize(proof["proof_path"]) if os.path.exists(proof["proof_path"]) else 0
